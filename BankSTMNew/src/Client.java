 ...
 * Client.java 
 * 
 *    This class behaves like a worker thread, which kicks of transactions
 *    (Withdraw from one account and deposit to another account). 
 *   
 * 
 * 
 * 
...
public class Client extends Thread 
{
  ...
  */
 public void setBankAccountTransaction(BankAccountTransaction bankAccountTransaction)
 {
